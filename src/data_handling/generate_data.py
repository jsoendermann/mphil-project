...
from datasets import load_dataset, create_dataset
from utils import convert_range_string
from argparse import ArgumentParser

parser = ArgumentParser(description='Collect data')
parser.add_argument('-a', '--algorithm', type=str, required=True, default='rnd_forest', help='The learning algorithm, one of [rnd_forest, lin_reg]')
...
generate_data(args.algorithm, classifier, dataset, all_percentage_data_values, parameters, parallel=args.parallel)
