...
% TODO JAMES "meta machine learning" a good term?
...
\chapter{Background}
\textit{This chapter describes the background assumed in the remainder of the document. We give a brief explanation of general machine learning principles together with a brief summary of the algorithms used. We then describe the datasets we used during the course of the project.}
...
\begin{figure}
\centering
% TODO JAMES maybe add reference to cs229 lecture notes
