...
\todo{maybe include code and a few diagrams in this section}
...
The constructor of \texttt{ExpectedImprovementTimesProbOfSuccessScheduler} expects a sequence of time intervals. Whenever the scheduler has used up its available time budget, the next time interval in the sequence is added to the remaining time.\todo{example}
...
% TODO END k-fold cross-validation spelling
...
% TODO FIGURE trim this to only show fixed sequence scheduler
  \includegraphics[trim=0 0 0 0,clip,width=\textwidth]{figures/kernel_issues1.pdf}
  \caption{@@}
  \label{kernel_issues1}
\end{figure}
\todo{interpret these figures}

\begin{figure}
\centering
% TODO FIGURE trim this to only show fixed sequence scheduler
  \includegraphics[trim=0 0 0 0,clip,width=\textwidth]{figures/kernel_issues2.pdf}
  \caption{@}
...
\centering
% TODO FIGURE trim this to only show fixed sequence scheduler
  \includegraphics[trim=0 0 0 0,clip,width=\textwidth]{figures/kernel_issues3.pdf}
  \caption{@}
