...
% TODO x-axis spelling
% TODO consistent capitalisation of section heads
% TODO END don't call your program "system"
% TODO PROOF maybe switch from "score" to "error"
...
% TODO PROOF refer to sections, not chapters (as numbers)
...
% TODO "explained below" -> precise section number
% TODO END random forest(s) consistent plural/capitalisation (also logreg)
% TODO ----------------------------------------------------------------
...
\tableofcontents
\listoffigures
% TODO END maybe make tables appear in this list (otherwise remove it)
\listoftables 
\listoftodos % TODO END remove this
...
\chapter{Background}
\textit{This chapter describes the background assumed in the remainder of the document. We give a brief explanation of general machine learning principles together with a summary of the algorithms used in this project. We then describe Bayesian optimisation and briefly mention third-party software we used to build our system.\todo{Explain: GPs=bg knowledge for modelling, BO for optimisation}}


% TODO performance/score/time
...
\todo{All four figures should show score, not 1-score}
...
Diverging from \cite{2014arXiv1406.3896S}, we reparameterise the gamma distribution with\todo{Explain why}
\begin{equation}
...
Figure \ref{gammadist} show how the distribution changes as $\psi$ and $\xi$ are varied.\todo{Only show three overall plots of the kernel}
...
\subsection{Sampling}
% TODO \cite{neal2003}
% TODO read mackay's book and correct this

% TODO decided to implement this when gpml minimise didn't work
...
% TODO maybe change xstar, ystar to f
\begin{align}
...
% TODO add general explanation & make diagram to illustrate slice sampling
...
% TOOD there exist variants, we describe our version
...
% TODO hyperparams chapter: explain how hyperparameter get used
...
\chapter{Scheduling} 
% TODO mention that the time used deciding & modelling doesn't matter
...
% TODO MAYBE mention drawing and how all figures are automatically saved
...
% TODO justify this decision well
...
% TODO MAYBE go more into details of what schedulers do
...
% TODO say how they were sourced from the auto weka list
...
% TODO rewrite this section, explain table
\begin{figure}
\centering
...
% TODO it's not harder, the initial values are more wrong
...
% TODO maybe find an example where the time is right
...
% TODO mention numerical inaccuracies
% TODO the problem where for very small amounts of remaining time, a behaves weirdly

\begin{figure}
\centering
% TODO FIGURE trim this to only show fixed sequence scheduler
  \includegraphics[trim=100 10 100 10,clip,frame,width=\textwidth]{figures/time_dropoff1.pdf}
  \caption{@@@}
  \label{time_dropoff1}
\end{figure}
\begin{figure}
...
% explore then exploit should not have fixed proportion
% fixed score, fastest model
%Greedy strategies such as those implemented as schedulers in this project are not optimal. This is 

%multi step problem
%reinforment learning, let it learn strategies on datasets
