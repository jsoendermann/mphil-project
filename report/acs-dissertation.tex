...
\setcounter{page}{1}
% TODO jordan: compscis see more data a a problem & try to get runtime under control, statisticians see it as something positive
...
% TODO ADD say that one can add a linear kernel to model different plateaus
...
\begin{figure}[p]
  %\begin{adjustwidth}{-\oddsidemargin-2in}{-\rightmargin-1.5in}
    \centering
    \includegraphics[angle=90,scale=0.8]{figures/architecture2.pdf}
